<footer class="main-footer">
    <div class="container-lg">
                ...
                <div id="begin-logo" class="mb-5">
                    <div class="qw-logo">
                        <img data-lazyloaded="1" data-placeholder-resp="190pxx80"
                            ...
                            loading="lazy"
                            data-src="https://qwords.com/v2/wp-content/themes/qwords/assets/images/icons/logo-dark.webp"
                            alt="qwords.webp" width="190px" height="80" data-ll-status="loaded"
                            class="entered litespeed-loaded"><noscript><img loading="lazy"
                                src="https://qwords.com/v2/wp-content/themes/qwords/assets/images/icons/logo-dark.webp"
                                alt="qwords.webp" width="190px" height="80" /></noscript>
                    </div>
                    ...
                    <a
                        ...
                        <div class="qw-logo">
                            <img data-lazyloaded="1" data-placeholder-resp="395pxx100px"
                                ...
                                loading="lazy"
                                data-src="https://qwords.com/v2/wp-content/themes/qwords/assets/images/icons/bsi.webp"
                                alt="bsi.webp" width="200px" height="100px" data-ll-status="loaded"
                                class="entered litespeed-loaded"><noscript><img loading="lazy"
                                    src="https://qwords.com/v2/wp-content/themes/qwords/assets/images/icons/bsi.webp"
                                    alt="bsi.webp" width="200" height="100px"></noscript>
                        </div>
                    </a>
                </div>
            ...
            <div class="col-12 col-lg-3">
                <div id="aboutus" class="mb-5">
                    ...
                    <ul class="list-unstyled lh-lg">
                        ...
                        <li><a href="https://qwords.com/v2/about-qwordscom/network/">Network &amp; Infrastructure</a>
                        </li>
                ...
                <div id="msa" class="mb-5">
                    ...
                    <ul class="list- lh-lg">
                        ...
                        <li><a href="https://qwords.com/v2/master-service-agreement/refund-policy">Refund Policy</a>
                        </li>
                        <li><a href="https://qwords.com/v2/master-service-agreement/privacy-policy/">Privacy Policy</a>
                        </li>
                        <li><a href="https://qwords.com/v2/master-service-agreement/product-life-cycle-policy/">Product
                                Life Cycle Policy</a></li>
                        <li><a href="https://qwords.com/v2/about-qwordscom/penggunaan-merek-dan-logo">Penggunaan Merek
                                dan Logo</a></li>
            ...
            <div class="col-12 col-lg-3">
                <div id="others" class="mb-5">
                    ...
                    <ul class="list-unstyled lh-lg">
                        ...
                        <li><a href="https://qwords.com/v2/manage-the-box-dedicated-colocation-server">Manage The Box
                                Server</a></li>
                        ...
                        <a href="https://pse.kominfo.go.id/tdpse-detail/1447">
                            <div class="me-3">
                                <img data-lazyloaded="1" data-placeholder-resp="100%x100%"
                                    ...
                                    alt="code.webp" width="100%" height="100%" data-ll-status="loaded"
                                    class="entered litespeed-loaded"><noscript><img loading="lazy"
                                        src="https://qwords.com/v2/wp-content/themes/qwords/assets/images/icons/code.webp"
                                        alt="code.webp" width="100%" height="100%"></noscript>
                            </div>
                        </a>
                        <a
                            ...
                            <div class="me-3">
                                <img data-lazyloaded="1" data-placeholder-resp="100%x100%"
                                    ...
                                    alt="icann-logo.webp" width="100%" height="100%" data-ll-status="loaded"
                                    class="entered litespeed-loaded"><noscript><img loading="lazy"
                                        src="https://qwords.com/v2/wp-content/themes/qwords/assets/images/icons/icann-logo.webp"
                                        alt="icann-logo.webp" width="100%" height="100%"></noscript>
                            </div>
                        </a>
                        <div class="me-3">
                            <img data-lazyloaded="1" data-placeholder-resp="100pxx100px"
                                ...
                                alt="badge_litespeed.svg" width="100px" height="100px" data-ll-status="loaded"
                                class="entered litespeed-loaded"><noscript><img loading="lazy"
                                    src="https://qwords.com/v2/wp-content/themes/qwords/assets/images/icons/badge_litespeed.svg"
                                    alt="badge_litespeed.svg" width="100px" height="100px"></noscript>
                        </div>
                        <div class="me-3">
                            <img data-lazyloaded="1" data-placeholder-resp="100pxx100px"
                                ...
                                alt="badge_whmadmin.svg" width="100px" height="100px" data-ll-status="loaded"
                                class="entered litespeed-loaded"><noscript><img loading="lazy"
                                    src="https://qwords.com/v2/wp-content/themes/qwords/assets/images/icons/badge_whmadmin.svg"
                                    alt="badge_whmadmin.svg" width="100px" height="100px"></noscript>
                        </div>
                        <div class="me-3">
                            <img data-lazyloaded="1" data-placeholder-resp="100%x100%"
                                ...
                                alt="acronis-cloud-tech.webp" width="100%" height="100%" data-ll-status="loaded"
                                class="entered litespeed-loaded"><noscript><img loading="lazy"
                                    src="https://qwords.com/v2/wp-content/themes/qwords/assets/images/icons/acronis-cloud-tech.webp"
                                    alt="acronis-cloud-tech.webp" width="100%" height="100%"></noscript>
                        </div>
                        <div class="me-3">
                            <img data-lazyloaded="1" data-placeholder-resp="100%x100%"
                                ...
                                alt="acronis-cloud-sales.webp" width="100%" height="100%" data-ll-status="loaded"
                                class="entered litespeed-loaded"><noscript><img loading="lazy"
                                    src="https://qwords.com/v2/wp-content/themes/qwords/assets/images/icons/acronis-cloud-sales.webp"
                                    alt="acronis-cloud-sales.webp" width="100%" height="100%"></noscript>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div style="min-height: 7rem;" class="d-flex justify-content-center pb-3 pb-lg-0">
            <div class="column justify-content-center mt-auto" id="end-footer">
                <div class="col-12 col-lg-auto pb-3">
                    <div class="hstack gap-3 justify-content-center justify-content-lg-center">
